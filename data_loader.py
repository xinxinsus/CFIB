...
def bert_batch_preprocessing(batch):
    ...
    fc_num,candidate_index = zip(*batch)
...
#    bcq_an, bc_an_mask = get_answer_pad_mask(bcq_an)
 ...
 #   beq_an, be_an_mask = get_answer_pad_mask(beq_an)
    ...
    return docid_list, clause_list, pairs, \
           ...
           fcq, fcq_mask, fcq_seg, fcq_len, fc_clause_len, fc_doc_len, fc_adj, fcq_an, fc_an_mask, candidate_index
...
class MyDataSet(Dataset):
    def __init__(self, pre_data):
        ...
        self._candidate_index=pre_data.candidate_index
    ...
    def __getitem__(self, i):
        ...
        fc_num,candidate_index  = \
            ...
            self._forward_c_num[i],self._candidate_index[i]
