...
if __name__ == '__main__':
    ...
    for dataset_type in dataset_type_list:
        output_path = 'data/RECCON/' + dataset_type + '_dual.pt'
        input_path = 'data/RECCON/' + dataset_type + '_pro.json'
        sample_list = []
    ...
    output_path = 'data/RECCON/dm.pt'
    train_data = torch.load('data/RECCON/train_dual.pt')
    test_data = torch.load('data/RECCON/test_dual.pt')
    val_data = torch.load('data/RECCON/val_dual.pt')
